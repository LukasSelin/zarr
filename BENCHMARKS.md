...
| `Children`, 10 / 100 / 1000 | 0.1 / 0.5 / 4.7 ms | 0.1 / 0.8 / 7.6 ms | 1 list + 1 get each |
| a group and its 10 / 100 arrays opened, by `OpenArray` | 0.2 / 1.8 ms | 0.5 / 2.9 ms | 21 / 201 gets |
| a group and its 10 / 100 arrays opened, by `OpenArrays` | 0.2 / 1.0 ms | 0.3 / 1.3 ms | 11 / 101 gets |
...
|---|---:|---:|
| `Children`, 10 / 100 / 1000 | 12 / 117 / 1170 ms | 1.3 / 7.0 / 67 ms |
| a group's 10 / 100 arrays, by `Children` and `OpenArray` | 24 / 241 ms | 13 / 125 ms |
| a group's 10 / 100 arrays, by `OpenArrays` | | 1.5 / 7.5 ms |
